...
namespace ServerRT.BLL
{
    ...
    {        
        ...
        public int receiveDir; //người nhận ms: 0: server, 1:client

        public BllServer(string name, string password)
        {
            this.name = name;
            this.status = "Offline";
